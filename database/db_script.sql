...
values ('Custon'),('Sport'),('SUV'),('Truck'),('Sedan');
...
--SELECT pg_get_serial_sequence('classification', 'classification_id');
--ALTER SEQUENCE public.classification_classification_id_seq RESTART WITH 1;
--truncate table public.classification cascade
